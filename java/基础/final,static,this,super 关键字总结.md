...
5. **补充内容：**`static{}`静态代码块与`{}`非静态代码块(构造代码块)
...
**转载自：**[https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/basic/final,static,this,super.md](https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/basic/final,static,this,super.md)