...
![ThreadLocal数据结构](https://gitee.com/zhou-ning/BlogImage/raw/master/java/ThreadLocal1.jpg)

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![内部结构](https://gitee.com/zhou-ning/BlogImage/raw/master/java/ThreadLocal2.jpg)
...
**转载自：**[https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/Multithread/JavaConcurrencyAdvancedCommonInterviewQuestions.md](https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/Multithread/JavaConcurrencyAdvancedCommonInterviewQuestions.md)