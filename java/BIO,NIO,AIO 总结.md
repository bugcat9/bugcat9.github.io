...
![传统BIO通信模型图](https://gitee.com/zhou-ning/BlogImage/raw/master/java/2.png)
...
![伪异步IO模型图](https://gitee.com/zhou-ning/BlogImage/raw/master/java/3.png)
...
![一个单线程中Selector维护3个Channel的示意图](https://gitee.com/zhou-ning/BlogImage/raw/master/java/Slector.png)
...
![NIO读写数据的方式](https://gitee.com/zhou-ning/BlogImage/raw/master/java/NIO读写数据的方式.png)
...
**转载自：**[https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/BIO-NIO-AIO.md](https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/BIO-NIO-AIO.md)