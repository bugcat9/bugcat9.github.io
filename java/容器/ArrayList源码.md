        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    /**
     * 修改这个ArrayList实例的容量为列表的当前真正大小。 应用程序可以使用此操作来最小化ArrayList实例的存储。 
     */
...
其中的`trimToSize`函数的讲解可以看[这个](https://www.cnblogs.com/hfczgo/p/4062826.html)
...
**转载自：**[https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/collection/ArrayList.md](https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/collection/ArrayList.md)